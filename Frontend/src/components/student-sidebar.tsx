...
const navItems = [
  { label: "Dashboard", href: "/student-dashboard", icon: FileText },
  ...
  { label: "Jobs / Openings", href: "/student/jobs", icon: Briefcase },
  { label: "My Applications", href: "/student/applications", icon: BookOpen },
...
export default function StudentSidebar({ isMobile = false }: { isMobile?: boolean }) {
    ...
    <aside className={rootClass}>
      ...
      <div className="flex items-center gap-3 px-2 pb-4 border-b border-blue-500/20">
        ...
        <div className="leading-tight">
          ...
          <div className="text-xs text-blue-300 tracking-widest">Student Portal</div>
        </div>
      </div>

      {/* Navigation Links */}
      <nav className="flex-1 flex flex-col gap-2 text-sm overflow-y-auto">{navItems.map((item) => {
